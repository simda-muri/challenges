...
are almost always *Sparsely* observed, and often only indirectly to observable quantities,
resulting in significant *Uncertainty*.
Sea ice, therefore, provides a natural application space for us to develop new mathematical 
techniques for characterizing “DSU” variables.
This package aims to formulate several prototypical inverse problems related to sea ice dynamics 
and navigation. These problems focus primarily on characterizing sea ice thickness and provide a 
sequence with increasing complexity and realism.
